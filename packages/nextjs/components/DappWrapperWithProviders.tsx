      ...
      <div className="grid gap-4 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-none">
              <span
                className="font-bold text-[16px] text-[#fffcf7]"
                style={{ fontFamily: "'Fraunces', Georgia, serif" }}
              >
                BlindFactor
              </span>
              <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-[#e8b86d]/60 mt-0.5">
        ...
        <div>
          ...
          <nav className="space-y-2">
            <Link href="/borrower" className="block text-sm text-[#fffcf7]/55 transition-colors hover:text-[#fffcf7]">
              Borrower desk
            </Link>
            <Link href="/lender" className="block text-sm text-[#fffcf7]/55 transition-colors hover:text-[#fffcf7]">
              Lender desk
            </Link>
          </nav>
        </div>
        ...
        <div>
          ...
          <nav className="space-y-2">
            <Link href="/docs" className="block text-sm text-[#fffcf7]/55 transition-colors hover:text-[#fffcf7]">
              Documentation
            </Link>
            <a
              ...
              className="block text-sm text-[#fffcf7]/55 transition-colors hover:text-[#fffcf7]"
            >
              GitHub
            </a>
          </nav>
        ...
        <div>
          ...
          <nav className="space-y-2">
            ...
            <Link href="/docs#terms" className="block text-sm text-[#fffcf7]/55 transition-colors hover:text-[#fffcf7]">
              Terms of Use
            </Link>
          </nav>
        </div>
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-3 border-t border-white/10 pt-3">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs text-[#fffcf7]/30 transition-colors hover:text-[#e07043]"
          >
            Zama Protocol
          </a>
          <a
