...
export default function LenderError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[LenderDashboard] unhandled error:", error);
  }, [error]);
        ...
        <div className="bg-[#1a1208] px-8 py-10 text-center">
          ...
          <p className="mt-2 text-sm text-[#fffcf7]/60">
            {isFheError
              ...
              : "The lender desk ran into an unexpected error. Try refreshing or reconnecting your wallet."}
          </p>
        </div>
