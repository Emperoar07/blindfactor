        ...
        <article className="space-y-12 min-w-0">
          <div className="overflow-hidden rounded-[1.75rem] bg-[#0f1117] px-8 py-10">
            ...
            <p className="mt-3 max-w-xl text-base text-[#fdfaf4]/60 leading-8">
              Everything you need to understand, participate in, and build on confidential invoice financing powered by
              Zama FHEVM.
            </p>
          </div>
          ...
          <Section id="overview" title="Overview">
            ...
            <p>
              ...
              individual bid terms, and repayment figures are all encrypted on chain using Fully Homomorphic Encryption
              provided by Zama. The winning bid is computed without ever decrypting the values, and only the authorized
              wallets can reveal their own numbers.
            </p>
            <InfoBox>
              BlindFactor is deployed on Ethereum Sepolia testnet. The settlement token is bfUSD, a confidential token
          ...
          <Section id="fhe-explanation" title="What FHE means here">
            <p>
              Fully Homomorphic Encryption lets a computer perform arithmetic on encrypted numbers and get an encrypted
              result, without ever seeing the underlying values. BlindFactor uses this to run its auction logic entirely
              on sealed data.
            </p>
            ...
            <InfoBox>
              Decryption requires a wallet signature. Only the wallet that is authorized by the contract for a given
              encrypted value can decrypt it. You cannot decrypt another user&apos;s bid or balance.
            </InfoBox>
          </Section>
          ...
          <Section id="borrower-guide" title="Borrower guide">
            <SubSection title="Creating a request">
              ...
              <ul className="list-disc list-inside space-y-1.5 text-[#3a3530]">
                <li>
                  <strong>Invoice amount:</strong> the face value you want to finance, denominated in bfUSD
                </li>
                <li>
                  <strong>Minimum payout:</strong> the lowest upfront amount you will accept from a lender
                </li>
                <li>
                  <strong>Bidding window:</strong> how many hours lenders have to submit bids
                </li>
                <li>
                  <strong>Days until repayment:</strong> when you will repay the winning lender
                </li>
                <li>
                  <strong>Invoice reference:</strong> a short label hashed on chain for your records
                </li>
              </ul>
              <p>
                Submitting the form encrypts the invoice amount and minimum payout in your browser, then broadcasts a
                transaction with only ciphertexts. No one can read your terms from the blockchain.
              </p>
            </SubSection>
            <SubSection title="Closing bidding and accepting a lender">
              <p>
                After the bidding window expires, or earlier if you choose, you can close bidding from the request card.
                Once bidding is closed you can decrypt the winning bid id, payout, and repayment using the Winning
                outputs decrypt panel. Enter the clear bid id into the Accept lender form. The app submits a public
                decryption proof for the bid id so the contract can reject substituted winners.
              </p>
            </SubSection>
            <SubSection title="Repaying">
              <p>
                After the lender funds the request your wallet receives a confidential bfUSD transfer. When you are
                ready to repay at or before the due date, use Mark repaid on the request card. This triggers a
                confidential transfer from your wallet to the lender for the agreed repayment amount.
              </p>
            </SubSection>
          </Section>
          ...
          <Section id="lender-guide" title="Lender guide">
            <SubSection title="Checking your balance">
              <p>
                Open the Lender desk and use the confidential balance decrypt panel to see your bfUSD before bidding.
                This requires a wallet signature to authorize decryption.
              </p>
            </SubSection>
            <SubSection title="Submitting a bid">
              <p>
                Open requests from borrowers other than your wallet will appear in the Lender desk. For any open
                request, enter:
              </p>
              <ul className="list-disc list-inside space-y-1.5 text-[#3a3530]">
                <li>
                  <strong>Payout now:</strong> what you will send the borrower upfront if selected
                </li>
                <li>
                  <strong>Repayment at due date:</strong> what you expect back from the borrower at maturity
                </li>
              </ul>
              <p>
                Both values are encrypted in your browser before the transaction. Other lenders cannot see your terms.
                The contract evaluates your bid against the current leader using FHE arithmetic and silently updates the
                winner if your offer is better and meets the borrower&apos;s minimum.
              </p>
            </SubSection>
            <SubSection title="Funding an accepted request">
              <p>
                If the borrower selects your bid you will see a Fund accepted request button on the request card.
                Clicking this initiates a confidential bfUSD transfer from your wallet to the borrower for the encrypted
          ...
          <Section id="settlement-token" title="Settlement token">
            <p>
              BlindFactor uses bfUSD, a confidential settlement token with encrypted balances. All balances and transfer
              amounts are stored and processed as FHE ciphertexts. A standard public token balance mapping would expose
              lender and borrower positions publicly. bfUSD ensures the financial flows remain sealed.
            </p>
            <SubSection title="Token details">
              <ul className="list-disc list-inside space-y-1.5 text-[#3a3530]">
                <li>
                  <strong>Name:</strong> BlindFactor USD
                </li>
                <li>
                  <strong>Symbol:</strong> bfUSD
                </li>
                <li>
...
BlindFactorToken:  0xB30b83482df69d1ac5a3c132dfFda86212A028f4`}</CodeBlock>
            ...
            <SubSection title="BlindFactorMarket">
              <p>
                The core contract managing the lifecycle of financing requests. Borrowers create requests with encrypted
                invoice terms. Lenders submit encrypted bids. The contract runs a winner tracking algorithm using FHE
                select and comparison operations. The winning bid is updated after every new submission, all without
                decryption.
              </p>
            </SubSection>
            <SubSection title="BlindFactorToken">
              <p>
                A confidential token compatible with the OpenZeppelin confidential fungible token interface shape.
                Balances are stored as euint64 encrypted integers. The market contract can call marketTransferFrom to
                move tokens between parties using encrypted amounts. Individuals can call confidentialTransfer to send
                tokens using an FHE input proof.
              </p>
            </SubSection>
          ...
          <Section id="privacy" title="Privacy policy">
            <p>
              BlindFactor does not collect, store, or process any personal information. There is no backend server, no
              database, and no analytics. All application logic runs client side in your browser and directly on
              Ethereum smart contracts.
            </p>
            <p>
              Wallet addresses that interact with the contracts are visible on the public blockchain. All other
              financial data, including invoice amounts, bid terms, token balances, and repayment figures, are encrypted
              on chain and accessible only to wallets authorized by the contract.
            </p>
            <p>
              By connecting your wallet and submitting transactions you acknowledge that blockchain transactions are
              public and permanent. You are solely responsible for the security of your private keys.
            </p>
          </Section>

          <Section id="cookies" title="Cookie policy">
            <p>
              BlindFactor uses a minimal set of browser storage mechanisms required for the application to function.
              There are no advertising cookies, no third-party trackers, and no analytics scripts.
            </p>
            <SubSection title="What we store locally">
              <ul className="list-disc list-inside space-y-1.5 text-[#3a3530]">
                <li>
                  <strong>Wallet connection state:</strong> RainbowKit stores your last connected wallet type in{" "}
                  <code>localStorage</code> so the app can reconnect automatically on your next visit. This data never
                  leaves your browser.
                </li>
                <li>
                  <strong>WalletConnect session:</strong> If you connect via WalletConnect, a temporary session key is
                  stored in <code>localStorage</code> for the duration of your session. It is cleared when you
                  disconnect.
                </li>
              </ul>
            </SubSection>
          ...
          <Section id="terms" title="Terms of use">
            ...
            <p>
              ...
              services, or regulated investment products. It is a decentralized protocol for consenting parties to
              coordinate confidential token transfers.
            </p>
            <p>
            ...
            <p>
              This software is released under the BSD 3 Clause Clear License. You may fork, modify, and deploy your own
              instance in accordance with that license.
            </p>
          </Section>
